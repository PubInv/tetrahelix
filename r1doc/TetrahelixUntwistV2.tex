...
\begin{abstract}
  ...
  are given,
  \highlighttext{
  allowing transformation through a continnum of 
...
shown in figs. [4] and \cref{fig:tetrobot}.
...
Since the axes are parallel, one may define the \emph{inradius}, represented by the letter $i$, of a
