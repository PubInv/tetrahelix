...
\Cref{fig:helixcomparison} illustrates this difference. Although the nodes conincide, \cref{graycoxeter} evaluated
at real values generates the black helix, and \cref{eq:colored} defines the red, yellow, and blue helices. (In this figure
these rail helices have been rendered at a slightly higher radius than the nodes; in actuality the helices are much close
to the edges between the nodes that they nearly match.)
...
optimal tetrahelices are triple helices.
...
\begin{theorem}
  \label{eventhirds}
  An optimal tetrahelix of any rail angle $\rho < \pi$ is a triple helix all nodes evenly spaced at $d/3$ intervals on the $z$ axis.
...
The curvature of a rail helix is given by:
\begin{equation}
...
more than the approach of \cref{eq:coxetergraygeneral}.
