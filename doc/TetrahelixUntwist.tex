...
is focused on the edges, rather than any sort of interpretaion of the tetrahedra as solids. \Cref{eq:general} is in terms of helices that are close
...
or solid modeler might prefer that. This formulation is equivalent to \Cref{eq:general}, but uses $\theta = \frac{\rho+ 2\pi}{3}$,
