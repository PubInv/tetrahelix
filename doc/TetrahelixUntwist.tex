...
Note: $r_{opt} $ is not an even function. I think it is only valid for non-negative values of $\rho$, an issue
we must face when we build our continuum.
