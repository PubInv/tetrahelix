...
%%  \text{one-hop} &= dist(H_{general}(0,0,\rho,d_{\rho}),H_{general}(0,1,\rho,d_{\rho},r))  \\  
...
** Add a better diagram that explains the ``two-hop'', ``one-hop'' process.  - done

** TODO: should I use vector notation for my formulae?  (yes!)

** Improve rail geometry diagram by making bolder.
